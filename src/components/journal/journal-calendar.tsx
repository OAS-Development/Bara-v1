...
export function JournalCalendar({ entries, selectedDate = new Date(), onDateSelect }: JournalCalendarProps) {
  ...
  const days = useMemo(() => {
    ...
    while (daysArray.length % 7 !== 0) {
      daysArray.push(new Date(end.getFullYear(), end.getMonth() + 1, daysArray.length - endOfMonth(currentMonth).getDate() + 1));
    }
